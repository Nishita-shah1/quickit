...
export default function Section5() {
  return (
    <section className="flex flex-col md:flex-row-reverse items-center justify-between p-8 bg-gray-100">
      {/* Text Section */}
      ...
      <div className="md:w-1/2 flex justify-center mt-6 md:mt-0">
        <Image src="/eco-delivery.jpg" alt="Carbon Footprints" width={350} height={250} className="rounded-md shadow-lg" />
      </div>
    </section>
  );
}
